...
// Use a wide canvas so the reported and historically claimed mirrored 320px
// tracker regions do not overlap. An overlapping clip can produce a false pass
// even when its origin is wrong.
...
assert.equal(before.tracker.align_x, 'right', 'tracker must be right-aligned for the mirror contract');
