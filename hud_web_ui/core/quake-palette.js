// core/quake-palette.js — the id1 palette (gfx/palette.lmp from pak0.pak).
// The FTE backend has no palette export yet, so this is what a bare number
// means there; a pak that replaces the palette is a reported preview drift.
export const QUAKE_PALETTE = [
